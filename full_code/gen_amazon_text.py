...
def get_text_output(response_body):
    ...
    for result in response_body['results']:
        #output += f"Token count: {result['tokenCount']}\n"
        output += result['outputText']
        #output += f"Completion reason: {result['completionReason']}\n"

    # rest of output generation
...
#            #output += f"Input token count: {response_body['inputTextTokenCount']}\n"
